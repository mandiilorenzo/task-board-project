...
export default function Home() {
  return (
    <main className="bg-[#0F0F0F] text-white min-h-screen flex flex-col items-center justify-center px-4">
      ...
      <section className="flex flex-wrap items-center justify-center gap-4">
        <div className="bg-[#FAFAFA] w-[160px] h-[40px] rounded-lg flex items-center justify-center px-2">
